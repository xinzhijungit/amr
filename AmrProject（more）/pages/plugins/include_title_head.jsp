			...
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="upload/emp/${empLogin.photo }" class="user-image" alt="User Image">
						<span class="hidden-xs">${empLogin.name }</span>
				</a>
					<ul class="dropdown-menu"> 
						<!-- User image -->
						<li class="user-header"><img src="upload/emp/${empLogin.photo }"
