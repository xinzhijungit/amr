...
import cn.xzj.amr.service.IDetailsService;
...
public class DetailsAction extends AbstractActionAdapter {
	...
	public ModelAndView editAmount(String updatestr, String deletestr,
		...
		if (super.isAuth(25, request)) {
			...
			try {
				Map<String,Object> map = (Map<String,Object> ) this.detailsService.editAmount(
						super.getEid(request), updateMap, deleteSet) ;
