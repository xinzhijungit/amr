					...
					<div class="box">
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								<tr>
									<th class="text-left">
										<input type="checkbox" id="selectAll"><strong>批量删除</strong>
									</th>
							...
							<div>
								<%-- <button class="btn btn-info" id="editBtn" style="display:none;">修改数量</button>--%>
								<span id="editBtn" class="btn btn-info" style="display:none;">修改数量</span>
								<%-- <button class="btn btn-warning" id="rmBtn">移出清单</button>--%>
								<span id="rmBtn" class="btn btn-warning" style="display:none;">移出清单</span>
